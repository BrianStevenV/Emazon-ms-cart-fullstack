...
import static com.PowerUpFullStack.ms_cart.infrastructure.configuration.feign.utils.ConstantsFeignClient.STOCK_POST_PRODUCTS_BY_PRODUCTS_IDS;
...
public interface IStockFeignClientExternalPort {
    ...
    @PostMapping(STOCK_POST_PRODUCTS_BY_PRODUCTS_IDS)
    List<ProductsResponseDto> getProductsByProductsIds(@RequestBody ProductIdsFeignClientDto productIdsRequestDto);
}
